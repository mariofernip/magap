...
public class FEstado_ac {
    ...
    return codigo;
     ...
     public static Estado_ac obtenerEstado_ac_xnombre(String codigoe) throws Exception {
      ...
      public static Estado_ac actualizarEstadoInventario_xnombre(int id_estado,String nombre_estado)throws Exception{
            Estado_ac est = new Estado_ac();
                  ArrayList <Parametro> lstpar = new  ArrayList<Parametro>();
                  lstpar.add(new Parametro(1,id_estado));
                  lstpar.add(new Parametro(2,nombre_estado));   
                      String sql = "select bodega.act_estado_ac(?,?)";
...
//                      crs = null;
      ...
      public static boolean eliminarEstado_ac(Estado_ac est) throws Exception{           
    boolean codigo=false;
    ArrayList<Parametro> lstpar= new ArrayList<Parametro>();
    String sql ="DELETE FROM bodega.estado_ac WHERE nombre_estado=?;";
    lstpar.add(new Parametro(1,est.getNombre_estado()));
    try {
...
//            }
           ...
           throw new Exception("Error al eliminar Estado_ac"+ex.getMessage());
        }
        return codigo;
} 
