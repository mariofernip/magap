 ...
 * @author User
 */
public class Ingresar_Inventario_1 extends javax.swing.JFrame {

    /**
     * Creates new form Ingresar_Inventario
     */
    public Ingresar_Inventario_1() {
        initComponents();
        try {
...
public void SoloLetras(JTextField stock){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Ingresar_Inventario_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ingresar_Inventario_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ingresar_Inventario_1().setVisible(true);
            }
        });
    }
